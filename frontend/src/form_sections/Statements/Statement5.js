...
const Statement5 = ({ handleLikertSelection, isSelected }) => {
  const descriptions = [
    "Strongly Disagree",
    "",
    "",
  ...
  const question = {
    id: "well_designed_for_activities",
    text: "This place feels well-designed for gathering, relaxing, or other activities.",
  };
